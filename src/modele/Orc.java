 ...
 *
 */
public class Orc extends Unite {
    /**
     ...
     */
    public Orc(final int equipe, final int x, final int y) {
        super(Jeu.orc, ATTAQUE, DEFENSE, PV, DEPLACEMENT, VISION, PORTEE, x, y, equipe);
    }
