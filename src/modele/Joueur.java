...
public class Joueur {
    ...
    public Joueur(final int numeroJoueur, final String pseudo) {
        ...
        if (numeroJoueur == 1) {
            ...
            listeUnite.add(new InfantaireLourd(1, 2, 1));
            listeUnite.add(new Infantaire(1, 3, 0));
            listeUnite.add(new Orc(1, 4, 0));
        } else if (numeroJoueur == 2) {
            listeUnite.add(new Archer(2, 11, 16));
            listeUnite.add(new Mage(2, 10, 17));
            listeUnite.add(new InfantaireLourd(2, 9, 17));
            listeUnite.add(new Infantaire(2, 8, 18));
            listeUnite.add(new Orc(2, 7, 18));
        } else if (numeroJoueur == 3) {
            listeUnite.add(new Archer(3, 11, 2));
            listeUnite.add(new Mage(3, 10, 2));
            listeUnite.add(new InfantaireLourd(3, 9, 1));
            listeUnite.add(new Infantaire(3, 8, 1));
            listeUnite.add(new Orc(3, 7, 0));
        } else {
            listeUnite.add(new Archer(4, 0, 16));
            listeUnite.add(new Mage(4, 1, 16));
            listeUnite.add(new InfantaireLourd(4, 2, 17));
            listeUnite.add(new Infantaire(4, 3, 17));
            listeUnite.add(new Orc(4, 4, 18));
      }
  }
