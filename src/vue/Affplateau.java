    ...
    public void paint(final Graphics graph) {
        ...
        for (ArrayList<Integer> listeUnite : Jeu.getInfoUnite()) {
            try {
                ...
                case 1:
                    bim = ImageIO.read(new File("images" + separateur + "infanterieLourd" + listeUnite.get(0) + ".png"));
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    bim = ImageIO.read(new File("images" + separateur + "orc" + listeUnite.get(0) + ".png"));
                    break;
                case 5:
                    bim = ImageIO.read(new File("images" + separateur + "infanterie" + listeUnite.get(0) + ".png"));
                    break;
                default:
                    break;
                }
        ...
        if (Jeu.getinteractionHex() != null) {
            for (ArrayList<Object> actionPossible : Jeu.getinteractionHex()) {
